...
const version = readable("0.11090");
const sortReverse = writable(false);
...
function sortOption(){
    sortReverse.set(!get_store_value(sortReverse));
    console.log("sortReverse is: ",get_store_value(sortReverse));
    setList(get_store_value(sortReverse),"sortReverse");
}
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			set_style(span, "opacity", "66%");
			add_location(span, file, 22, 67, 479);
			attr_dev(button, "id", "main_link");
			attr_dev(button, "class", "svelte-lbio89");
			add_location(button, file, 22, 0, 412);
		},
...
function fallback_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(button, file$1, 39, 8, 967);
		},
		m: function mount(target, anchor) {
			insert_dev(target, button, anchor);
...
function create_fragment$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div0, file$1, 34, 0, 787);
			attr_dev(div1, "class", "modal svelte-1df7d0c");
			add_location(div1, file$1, 36, 0, 888);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
/* src/components/Create.svelte generated by Svelte v3.29.4 */
...
function create_if_block_2(ctx) {
	...
	const block = {
		c: function create() {
			button = element("button");
			div = element("div");
			attr_dev(div, "class", "minus svelte-1ds5st4");
			add_location(div, file$2, 171, 20, 4697);
			attr_dev(button, "name", "rem-item");
			attr_dev(button, "class", "svelte-1ds5st4");
			add_location(button, file$2, 170, 16, 4620);
		},
		m: function mount(target, anchor) {
			insert_dev(target, button, anchor);
...
function create_each_block(key_1, ctx) {
	...
	function input_input_handler() {
		/*input_input_handler*/ ctx[13].call(input, /*each_value*/ ctx[20], /*i*/ ctx[21]);
	}
	...
	const block = {
		...
		c: function create() {
			...
			input.required = true;
			attr_dev(input, "class", "svelte-1ds5st4");
			add_location(input, file$2, 167, 16, 4431);
			attr_dev(div0, "class", "cross svelte-1ds5st4");
			add_location(div0, file$2, 175, 20, 4869);
			attr_dev(button, "name", "add-item");
			attr_dev(button, "class", "svelte-1ds5st4");
			add_location(button, file$2, 174, 16, 4787);
			attr_dev(div1, "class", "itemslist svelte-1ds5st4");
			add_location(div1, file$2, 164, 12, 4327);
			this.first = div1;
		},
		m: function mount(target, anchor) {
			insert_dev(target, div1, anchor);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(164:8) {#each items as item, i (i)}",
		ctx
	});
...
function create_if_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(button, "class", "svelte-1ds5st4");
			add_location(button, file$2, 181, 12, 5039);
		},
		m: function mount(target, anchor) {
			insert_dev(target, button, anchor);
...
// (191:4) <Modal content="Are you sure you wanna delete this container?" on:cancel="{ () => delModal = false}" on:close="{ () => delModal = false}">
function create_default_slot(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(br, file$2, 191, 8, 5487);
			set_style(button0, "background-color", "red");
			attr_dev(button0, "class", "svelte-1ds5st4");
			add_location(button0, file$2, 193, 12, 5538);
			attr_dev(button1, "class", "svelte-1ds5st4");
			add_location(button1, file$2, 194, 12, 5631);
			attr_dev(div, "class", "row-buttons svelte-1ds5st4");
			add_location(div, file$2, 192, 8, 5500);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(191:4) <Modal content=\\\"Are you sure you wanna delete this container?\\\" on:cancel=\\\"{ () => delModal = false}\\\" on:close=\\\"{ () => delModal = false}\\\">",
		ctx
	});
...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(input0, "maxlength", "28");
			attr_dev(input0, "placeholder", "The Container Name");
			input0.required = true;
			attr_dev(input0, "class", "svelte-1ds5st4");
			add_location(input0, file$2, 158, 8, 3985);
			...
			attr_dev(input1, "class", "svelte-1ds5st4");
			add_location(input1, file$2, 160, 8, 4132);
			attr_dev(button, "name", "save-container");
			attr_dev(button, "class", "svelte-1ds5st4");
			add_location(button, file$2, 183, 12, 5199);
			attr_dev(div0, "class", "buttons svelte-1ds5st4");
			add_location(div0, file$2, 179, 8, 4964);
			attr_dev(label, "class", "svelte-1ds5st4");
			add_location(label, file$2, 157, 4, 3969);
			attr_dev(div1, "classname", "create-new");
			add_location(div1, file$2, 156, 0, 3898);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
		...
		p: function update(ctx, [dirty]) {
			...
			if (dirty & /*newItem, items, remItem, inputMsg*/ 804) {
...
function instance$2($$self, $$props, $$invalidate) {
	...
	function newItem(itm) {
		if (items[items.length - 1][0] !== "") {
			...
			$$invalidate(2, items = [...items, ["", false]]);
		}
	}
...
/* src/components/Container.svelte generated by Svelte v3.29.4 */
...
function create_if_block$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span, file$3, 134, 12, 3588);
			attr_dev(ul, "class", "item-list svelte-8s8459");
			add_location(ul, file$3, 135, 12, 3644);
			attr_dev(button, "class", "edit-button svelte-8s8459");
			attr_dev(button, "name", "edit-button");
			add_location(button, file$3, 141, 16, 3918);

			attr_dev(div0, "class", div0_class_value = "" + (null_to_empty(/*interact*/ ctx[1]
			? "interactive-text-on"
			: "interactive-text-off") + " svelte-8s8459"));

			add_location(div0, file$3, 142, 16, 4019);
			attr_dev(div1, "class", "options svelte-8s8459");
			add_location(div1, file$3, 140, 12, 3880);
			attr_dev(div2, "class", "details svelte-8s8459");
			add_location(div2, file$3, 132, 8, 3496);
		},
		m: function mount(target, anchor) {
		...
		p: function update(ctx, dirty) {
			if (!current || dirty & /*type*/ 16) set_data_dev(t0, /*type*/ ctx[4]);
...
function create_each_block$1(ctx) {
	...
	const block = {
		c: function create() {
			li = element("li");
			t = text(t_value);
			attr_dev(li, "class", li_class_value = "" + (null_to_empty(/*item*/ ctx[11][1] ? "item-not-red" : "item-red") + " svelte-8s8459"));
			add_location(li, file$3, 137, 20, 3727);
		},
		m: function mount(target, anchor) {
		...
		p: function update(new_ctx, dirty) {
			...
			if (dirty & /*items*/ 1 && li_class_value !== (li_class_value = "" + (null_to_empty(/*item*/ ctx[11][1] ? "item-not-red" : "item-red") + " svelte-8s8459"))) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(137:16) {#each items as item,i}",
		ctx
	});
...
function create_fragment$3(ctx) {
	...
	let mounted;
	let dispose;
	let if_block = !/*isSum*/ ctx[2] && create_if_block$1(ctx);
	...
	const block = {
		c: function create() {
			...
			attr_dev(div0, "class", "svelte-8s8459");
			add_location(div0, file$3, 125, 8, 3318);
			set_style(hr, "width", "90%");
			set_style(hr, "border-color", "#e1e2e186");
			add_location(hr, file$3, 128, 8, 3397);

			attr_dev(div1, "class", div1_class_value = "" + (null_to_empty(/*interact*/ ctx[1]
			? "containersum containersum-on"
			: "containersum containersum-off") + " svelte-8s8459"));

			add_location(div1, file$3, 123, 4, 3216);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
/* src/assets/github2.svg generated by Svelte v3.29.4 */
...
function create_fragment$4(ctx) {
	...
	return {
		...
		h() {
			...
			attr(path0, "stroke", "#858383");
			attr(path0, "stroke-miterlimit", "10");
			attr(path0, "stroke-width", "2");
			attr(path0, "d", "M3,25c0,12.148,9.852,22,22,22s22-9.852,22-22S37.148,3,25,3S3,12.852,3,25z");
			attr(path1, "fill", "none");
			attr(path1, "stroke", "#858383");
			attr(path1, "stroke-linecap", "round");
			attr(path1, "stroke-linejoin", "round");
			attr(path1, "stroke-miterlimit", "10");
			attr(path1, "d", "M38 25.655c4.51-.282 7.58-.017 9 .163M37.401 27.519c5.169 0 8.498.675 9.699.967M3 25.802c1.42-.181 4.49-.445 9-.163M2.999 28.476c1.199-.292 4.528-.968 9.701-.968");
			attr(path2, "fill", "none");
			attr(path2, "stroke", "#858383");
			...
			attr(path3, "stroke", "#858383");
			attr(path3, "stroke-miterlimit", "10");
			attr(path3, "stroke-width", "2");
			attr(path3, "d", "M31,45.7v-6.1c0-2.7-1.9-6.5-4.5-6.5h-2.8c-2.6,0-4.7,3.8-4.7,6.5V46");
...
/* src/components/ContainerSum.svelte generated by Svelte v3.29.4 */
...
function create_else_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div0, file$4, 50, 12, 1520);
			add_location(div1, file$4, 55, 12, 1760);
			attr_dev(div2, "class", "welcome svelte-11ucazf");
			add_location(div2, file$4, 48, 8, 1472);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div2, anchor);
...
// (42:4) {#each localContainers as container, i (container.id)}
function create_each_block$2(key_1, ctx) {
	...
	let current;
	const container_spread_levels = [/*container*/ ctx[2]];
	let container_props = {};
	...
	const block = {
		...
		c: function create() {
			...
			add_location(div, file$4, 42, 12, 1314);
			this.first = div;
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
		...
		p: function update(ctx, dirty) {
			const container_changes = (dirty & /*localContainers*/ 1)
			? get_spread_update(container_spread_levels, [get_spread_object(/*container*/ ctx[2])])
			: {};
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(42:4) {#each localContainers as container, i (container.id)}",
		ctx
	});
...
function create_fragment$5(ctx) {
	...
	let github;
	let current;
	let each_value = /*localContainers*/ ctx[0];
	validate_each_argument(each_value);
	const get_key = ctx => /*container*/ ctx[2].id;
	...
	const block = {
		c: function create() {
			...
			attr_dev(a, "class", "github svelte-11ucazf");
			attr_dev(a, "href", "https://github.com/gageracer/myStuff");
			attr_dev(a, "target", "_blank");
			attr_dev(a, "type", "image/svg+xml");
			add_location(a, file$4, 60, 8, 1916);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
		...
		p: function update(ctx, [dirty]) {
			if (dirty & /*localContainers*/ 1) {
				const each_value = /*localContainers*/ ctx[0];
				validate_each_argument(each_value);
				group_outros();
				for (let i = 0; i < each_blocks.length; i += 1) each_blocks[i].r();
				validate_each_keys(ctx, each_value, get_each_context$2, get_key);
				each_blocks = update_keyed_each(each_blocks, dirty, get_key, 1, ctx, each_value, each_1_lookup, t.parentNode, fix_and_outro_and_destroy_block, create_each_block$2, t, get_each_context$2);
...
function instance$5($$self, $$props, $$invalidate) {
	let $sortReverse;
	validate_store(sortReverse, "sortReverse");
	component_subscribe($$self, sortReverse, $$value => $$invalidate(1, $sortReverse = $$value));
	let { $$slots: slots = {}, $$scope } = $$props;
	validate_slots("ContainerSum", slots, []);

	let localContainers = get_store_value(sortReverse)
	? get_store_value(myContainers).reverse()
	: get_store_value(myContainers);
	...
	$$self.$inject_state = $$props => {
		if ("localContainers" in $$props) $$invalidate(0, localContainers = $$props.localContainers);
	};
	...
	$$self.$$.update = () => {
		if ($$self.$$.dirty & /*$sortReverse, localContainers*/ 3) {
			 {
				$$invalidate(0, localContainers = localContainers.reverse());
			}
		}
	};
...
/* src/components/NewButton.svelte generated by Svelte v3.29.4 */
const file$5 = "src/components/NewButton.svelte";
...
function create_if_block_1$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file$5, 80, 4, 1989);
			attr_dev(button_1, "id", "sort-reverse");
			attr_dev(button_1, "class", "svelte-1ykcag7");
			add_location(button_1, file$5, 79, 0, 1934);
		},
		m: function mount(target, anchor) {
			...
			if (!mounted) {
				dispose = listen_dev(button_1, "click", sortOption, false, false, false);
				mounted = true;
			}
		},
		p: noop,
...
function create_if_block$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(div, "class", "svelte-1ykcag7");
			add_location(div, file$5, 76, 4, 1846);
			attr_dev(button_1, "id", "menu-edit-create");
			attr_dev(button_1, "name", "new-list");
			attr_dev(button_1, "aria-label", "Create Container");
			attr_dev(button_1, "class", "svelte-1ykcag7");
			add_location(button_1, file$5, 75, 0, 1730);
		},
		m: function mount(target, anchor) {
			insert_dev(target, button_1, anchor);
			append_dev(button_1, div);
...
function create_fragment$6(ctx) {
	...
	function select_block_type(ctx, dirty) {
		if (/*button*/ ctx[0] === "newlist") return create_if_block$2;
		if (/*button*/ ctx[0] === "sortReverse") return create_if_block_1$1;
	}
...
function instance$6($$self, $$props, $$invalidate) {
	...
	$$self.$capture_state = () => ({ toggle, sortOption, button });
...
/* src/CurrentPage.svelte generated by Svelte v3.29.4 */
...
function create_else_block$1(ctx) {
	...
	let mounted;
	let dispose;
	containersum = new ContainerSum({ $$inline: true });

	newbutton0 = new NewButton({
			props: { button: "newlist" },
			$$inline: true
		});

	newbutton1 = new NewButton({
			props: { button: "sortReverse" },
			$$inline: true
		});
	...
	const block = {
		c: function create() {
			...
			t0 = space();
			create_component(newbutton0.$$.fragment);
			t1 = space();
			create_component(newbutton1.$$.fragment);
			attr_dev(div, "class", "content svelte-fzfq20");
			add_location(div, file$6, 53, 4, 1458);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			mount_component(containersum, div, null);
			append_dev(div, t0);
			mount_component(newbutton0, div, null);
			append_dev(div, t1);
			mount_component(newbutton1, div, null);
			current = true;
		...
		i: function intro(local) {
			...
			transition_in(newbutton0.$$.fragment, local);
			transition_in(newbutton1.$$.fragment, local);
		...
		o: function outro(local) {
			...
			transition_out(newbutton0.$$.fragment, local);
			transition_out(newbutton1.$$.fragment, local);
		...
		d: function destroy(detaching) {
			...
			destroy_component(newbutton0);
			destroy_component(newbutton1);
...
function create_if_block_1$2(ctx) {
	...
	function switch_props(ctx) {
		return {
			props: {
				name: /*$tmpCont*/ ctx[3].name,
				type: /*$tmpCont*/ ctx[3].type,
				items: /*$tmpCont*/ ctx[3].items,
				id: /*$tmpCont*/ ctx[3].id,
				editt: true
			},
			$$inline: true
	...
	const block = {
		...
		p: function update(ctx, dirty) {
			...
			if (dirty & /*$tmpCont*/ 8) switch_instance_changes.name = /*$tmpCont*/ ctx[3].name;
			if (dirty & /*$tmpCont*/ 8) switch_instance_changes.type = /*$tmpCont*/ ctx[3].type;
			if (dirty & /*$tmpCont*/ 8) switch_instance_changes.items = /*$tmpCont*/ ctx[3].items;
			if (dirty & /*$tmpCont*/ 8) switch_instance_changes.id = /*$tmpCont*/ ctx[3].id;
...
function create_if_block$3(ctx) {
	...
	function switch_props(ctx) {
		return {
			props: {
				name: /*$unSaved*/ ctx[2].name,
				type: /*$unSaved*/ ctx[2].type,
				items: /*$unSaved*/ ctx[2].items,
				editt: false
			},
			$$inline: true
		};
	...
	const block = {
		...
		p: function update(ctx, dirty) {
			const switch_instance_changes = {};
			if (dirty & /*$unSaved*/ 4) switch_instance_changes.name = /*$unSaved*/ ctx[2].name;
			if (dirty & /*$unSaved*/ 4) switch_instance_changes.type = /*$unSaved*/ ctx[2].type;
			if (dirty & /*$unSaved*/ 4) switch_instance_changes.items = /*$unSaved*/ ctx[2].items;
...
function create_fragment$7(ctx) {
	...
	function select_block_type(ctx, dirty) {
		if (/*$mypage*/ ctx[1] === "newlist") return 0;
		if (/*$mypage*/ ctx[1] === "editlist") return 1;
		return 2;
	}
...
function instance$7($$self, $$props, $$invalidate) {
	...
	component_subscribe($$self, mypage, $$value => $$invalidate(1, $mypage = $$value));
	validate_store(unSaved, "unSaved");
	component_subscribe($$self, unSaved, $$value => $$invalidate(2, $unSaved = $$value));
	validate_store(tmpCont, "tmpCont");
	component_subscribe($$self, tmpCont, $$value => $$invalidate(3, $tmpCont = $$value));
	let { $$slots: slots = {}, $$scope } = $$props;
	...
	const outroend_handler = () => $$invalidate(0, status = "outro ended");
	...
	$$self.$$.update = () => {
		...
		if ($$self.$$.dirty & /*$mypage*/ 2) {
			 console.log("Current page is: " + $mypage);
		}

		if ($$self.$$.dirty & /*w, h*/ 48) {
			 ratio = (w / h).toFixed(2);
		}
	};

	return [status, $mypage, $unSaved, $tmpCont, w, h, outroend_handler];
}

class CurrentPage extends SvelteComponentDev {
	constructor(options) {
		super(options);
		init(this, options, instance$7, create_fragment$7, safe_not_equal, { w: 4, h: 5 });
		...
		if (/*h*/ ctx[5] === undefined && !("h" in props)) {
...
function create_fragment$8(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(main, "class", "svelte-12e4uyx");
			add_render_callback(() => /*main_elementresize_handler*/ ctx[2].call(main));
			add_location(main, file$7, 60, 0, 1382);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
