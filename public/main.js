...
/* src/components/Create.svelte generated by Svelte v3.23.2 */
...
/* src/components/NewButton.svelte generated by Svelte v3.23.2 */
...
/* src/components/Container.svelte generated by Svelte v3.23.2 */
...
function create_if_block$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(ul, "class", "item-list svelte-1vaxuux");
			add_location(ul, file$4, 142, 12, 3605);
			attr_dev(button, "class", "edit-button svelte-1vaxuux");
			attr_dev(button, "name", "edit-button");
			add_location(button, file$4, 148, 16, 3879);

			attr_dev(div0, "class", div0_class_value = "" + (null_to_empty(/*interact*/ ctx[1]
			? "interactive-text-on"
			: "interactive-text-off") + " svelte-1vaxuux"));

			add_location(div0, file$4, 149, 16, 3980);
			attr_dev(div1, "class", "options svelte-1vaxuux");
			add_location(div1, file$4, 147, 12, 3841);
			attr_dev(div2, "class", "details svelte-1vaxuux");
			add_location(div2, file$4, 136, 8, 3430);
		},
		m: function mount(target, anchor) {
...
function create_each_block$1(ctx) {
	...
	const block = {
		c: function create() {
			li = element("li");
			t = text(t_value);
			attr_dev(li, "class", li_class_value = "" + (null_to_empty(/*item*/ ctx[11][1] ? "item-not-red" : "item-red") + " svelte-1vaxuux"));
			add_location(li, file$4, 144, 20, 3688);
		},
		m: function mount(target, anchor) {
		...
		p: function update(new_ctx, dirty) {
			...
			if (dirty & /*items*/ 1 && li_class_value !== (li_class_value = "" + (null_to_empty(/*item*/ ctx[11][1] ? "item-not-red" : "item-red") + " svelte-1vaxuux"))) {
...
function create_fragment$4(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(div0, "class", "svelte-1vaxuux");
			add_location(div0, file$4, 129, 8, 3252);
			set_style(hr, "width", "90%");
			set_style(hr, "border-color", "#e1e2e186");
			add_location(hr, file$4, 132, 8, 3331);

			attr_dev(div1, "class", div1_class_value = "" + (null_to_empty(/*interact*/ ctx[1]
			? "containersum containersum-on"
			: "containersum containersum-off") + " svelte-1vaxuux"));

			add_location(div1, file$4, 127, 4, 3150);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
/* src/components/GoogleSignInButton.svelte generated by Svelte v3.23.2 */

const { console: console_1$2 } = globals;
const file$5 = "src/components/GoogleSignInButton.svelte";
...
function create_fragment$5(ctx) {
	...
	const block = {
		c: function create() {
			...
			script.async = true;
			script.defer = true;
			add_location(script, file$5, 11, 4, 350);
...
/* src/components/ContainerSum.svelte generated by Svelte v3.23.2 */
const file$6 = "src/components/ContainerSum.svelte";
...
function create_else_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			t3 = space();
			add_location(div0, file$6, 39, 12, 1102);
			add_location(div1, file$6, 44, 12, 1342);
			attr_dev(div2, "class", "welcome svelte-lppm3v");
			add_location(div2, file$6, 37, 8, 1054);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div2, anchor);
...
// (31:4) {#each $myContainers as container, i (container.id)}
function create_each_block$2(key_1, ctx) {
	...
	const block = {
		...
		c: function create() {
			...
			t = space();
			add_location(div, file$6, 31, 12, 896);
			this.first = div;
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(31:4) {#each $myContainers as container, i (container.id)}",
		ctx
	});
...
/* src/CurrentPage.svelte generated by Svelte v3.23.2 */
...
function create_else_block$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file$7, 60, 4, 1558);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
...
function create_fragment$8(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(main, file$8, 32, 0, 769);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
