...
const version = readable("0.1019a");
...
function fallback_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(button, file$1, 43, 8, 937);
		},
		m: function mount(target, anchor) {
			insert_dev(target, button, anchor);
...
function create_fragment$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div0, file$1, 38, 0, 757);
			attr_dev(div1, "class", "modal svelte-1df7d0c");
			add_location(div1, file$1, 40, 0, 858);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
/* src/components/Create.svelte generated by Svelte v3.29.0 */
...
function create_if_block_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file$2, 184, 20, 4809);
			attr_dev(button, "name", "rem-item");
			attr_dev(button, "class", "svelte-dfzaog");
			add_location(button, file$2, 183, 16, 4732);
		},
		m: function mount(target, anchor) {
			insert_dev(target, button, anchor);
...
function create_each_block(key_1, ctx) {
	...
	const block = {
		...
		c: function create() {
			...
			add_location(input, file$2, 180, 16, 4543);
			attr_dev(div0, "class", "cross svelte-dfzaog");
			add_location(div0, file$2, 188, 20, 4981);
			attr_dev(button, "name", "add-item");
			attr_dev(button, "class", "svelte-dfzaog");
			add_location(button, file$2, 187, 16, 4899);
			attr_dev(div1, "class", "itemslist svelte-dfzaog");
			add_location(div1, file$2, 177, 12, 4432);
			this.first = div1;
		},
		m: function mount(target, anchor) {
			insert_dev(target, div1, anchor);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(177:8) {#each items as item, i (i)}",
		ctx
	});
...
function create_if_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(button, "class", "svelte-dfzaog");
			add_location(button, file$2, 194, 12, 5151);
		},
		m: function mount(target, anchor) {
			insert_dev(target, button, anchor);
...
// (204:4) <Modal content="Are you sure you wanna delete this container?" on:cancel="{ () => delModal = false}" on:close="{ () => delModal = false}">
function create_default_slot(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(204:4) <Modal content=\\\"Are you sure you wanna delete this container?\\\" on:cancel=\\\"{ () => delModal = false}\\\" on:close=\\\"{ () => delModal = false}\\\">",
		ctx
	});
...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(input0, file$2, 171, 8, 4090);
			...
			add_location(input1, file$2, 173, 8, 4237);
			attr_dev(button, "name", "save-container");
			attr_dev(button, "class", "svelte-dfzaog");
			add_location(button, file$2, 196, 12, 5311);
			attr_dev(div0, "class", "buttons svelte-dfzaog");
			add_location(div0, file$2, 192, 8, 5076);
			attr_dev(label, "class", "svelte-dfzaog");
			add_location(label, file$2, 170, 4, 4074);
			attr_dev(div1, "classname", "create-new");
			add_location(div1, file$2, 169, 0, 4003);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
/* src/components/Container.svelte generated by Svelte v3.29.0 */
...
function create_if_block$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span, file$3, 137, 12, 3461);
			attr_dev(ul, "class", "item-list svelte-b2r386");
			add_location(ul, file$3, 138, 12, 3517);
			attr_dev(button, "class", "edit-button svelte-b2r386");
			attr_dev(button, "name", "edit-button");
			add_location(button, file$3, 144, 16, 3791);

			attr_dev(div0, "class", div0_class_value = "" + (null_to_empty(/*interact*/ ctx[1]
			? "interactive-text-on"
			: "interactive-text-off") + " svelte-b2r386"));

			add_location(div0, file$3, 145, 16, 3892);
			attr_dev(div1, "class", "options svelte-b2r386");
			add_location(div1, file$3, 143, 12, 3753);
			attr_dev(div2, "class", "details svelte-b2r386");
			add_location(div2, file$3, 135, 8, 3369);
		},
		m: function mount(target, anchor) {
...
function create_each_block$1(ctx) {
	...
	const block = {
		c: function create() {
			li = element("li");
			t = text(t_value);
			attr_dev(li, "class", li_class_value = "" + (null_to_empty(/*item*/ ctx[11][1] ? "item-not-red" : "item-red") + " svelte-b2r386"));
			add_location(li, file$3, 140, 20, 3600);
		},
		m: function mount(target, anchor) {
		...
		p: function update(new_ctx, dirty) {
			...
			if (dirty & /*items*/ 1 && li_class_value !== (li_class_value = "" + (null_to_empty(/*item*/ ctx[11][1] ? "item-not-red" : "item-red") + " svelte-b2r386"))) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(140:16) {#each items as item,i}",
		ctx
	});
...
function create_fragment$3(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(div0, "class", "svelte-b2r386");
			add_location(div0, file$3, 128, 8, 3191);
			set_style(hr, "width", "90%");
			set_style(hr, "border-color", "#e1e2e186");
			add_location(hr, file$3, 131, 8, 3270);

			attr_dev(div1, "class", div1_class_value = "" + (null_to_empty(/*interact*/ ctx[1]
			? "containersum containersum-on"
			: "containersum containersum-off") + " svelte-b2r386"));

			add_location(div1, file$3, 126, 4, 3089);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
/* src/components/GoogleSignInButton.svelte generated by Svelte v3.29.0 */

const { console: console_1$2 } = globals;
const file$4 = "src/components/GoogleSignInButton.svelte";
...
function create_fragment$4(ctx) {
	...
	const block = {
		c: function create() {
			...
			t = space();
			div = element("div");
			if (script.src !== (script_src_value = "https://apis.google.com/js/platform.js")) attr_dev(script, "src", script_src_value);
			script.async = true;
			script.defer = true;
			add_location(script, file$4, 11, 4, 350);
			attr_dev(meta, "name", "google-signin-client_id");
			attr_dev(meta, "content", "117413078094-c1i6mg67nt6ap9dhp0knimdq8qjdqqao.apps.googleusercontent.com");
			add_location(meta, file$4, 12, 4, 429);
			attr_dev(div, "class", "g-signin2");
			attr_dev(div, "data-longtitle", "true");
			attr_dev(div, "data-onsuccess", "onSignIn");
			add_location(div, file$4, 15, 0, 566);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
function instance$4($$self, $$props) {
	...
	Object.keys($$props).forEach(key => {
		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1$2.warn(`<GoogleSignInButton> was created with unknown prop '${key}'`);
	});
...
/* src/components/ContainerSum.svelte generated by Svelte v3.29.0 */
...
function create_else_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			t3 = space();
			add_location(div0, file$5, 43, 12, 1337);
			add_location(div1, file$5, 48, 12, 1577);
			attr_dev(div2, "class", "welcome svelte-147041o");
			add_location(div2, file$5, 41, 8, 1289);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div2, anchor);
...
// (35:4) {#each localContainers as container, i (container.id)}
function create_each_block$2(key_1, ctx) {
	...
	const block = {
		...
		c: function create() {
			...
			t = space();
			add_location(div, file$5, 35, 12, 1131);
			this.first = div;
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(35:4) {#each localContainers as container, i (container.id)}",
		ctx
	});
...
/* src/components/NewButton.svelte generated by Svelte v3.29.0 */
const file$6 = "src/components/NewButton.svelte";
...
function create_if_block_1$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file$6, 84, 4, 1943);
			attr_dev(button_1, "id", "sort-reverse");
			attr_dev(button_1, "class", "svelte-1xdx2gl");
			add_location(button_1, file$6, 83, 0, 1888);
		},
		m: function mount(target, anchor) {
...
/* src/CurrentPage.svelte generated by Svelte v3.29.0 */

const { console: console_1$3 } = globals;
const file$7 = "src/CurrentPage.svelte";
...
function create_else_block$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file$7, 59, 4, 1509);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
...
function instance$7($$self, $$props, $$invalidate) {
	...
	Object.keys($$props).forEach(key => {
		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1$3.warn(`<CurrentPage> was created with unknown prop '${key}'`);
	});
...
class CurrentPage extends SvelteComponentDev {
	constructor(options) {
		super(options);
		init(this, options, instance$7, create_fragment$7, safe_not_equal, { w: 0, h: 1 });
		...
		if (/*w*/ ctx[0] === undefined && !("w" in props)) {
			console_1$3.warn("<CurrentPage> was created without expected prop 'w'");
		}

		if (/*h*/ ctx[1] === undefined && !("h" in props)) {
			console_1$3.warn("<CurrentPage> was created without expected prop 'h'");
		}
	}
...
function create_fragment$8(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(main, "class", "svelte-pqa80n");
			add_render_callback(() => /*main_elementresize_handler*/ ctx[2].call(main));
			add_location(main, file$8, 28, 0, 748);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
